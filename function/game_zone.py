...
class card_fight(object):
    ...
    def getATK(self,atk, lucky, wiz_value):
        ...
        atk1 = ['拿棒棒糖攻擊','丟石頭','戳一下','丟樸克牌','丟RAM攻擊','咬一口','丟榴槤',
                ...
                '珍珠奶茶不要奶','先王御賜尚方寶劍','來一罐丫比吧','餵食含笑半部顛','深夜的貓叫春','喵喵肉球拳','野球拳',
    ...
    def getDEF(self,DEF, lucky):
        ...
        def0 = ['扮鬼臉嚇人','盾檔','太極一式','講笑話','岩壁','灑豆子趕人','格檔','招架','我是香菇',
                ...
                '跳肚皮舞','土下跪','此路不通','翻開可愛巧虎島','糖糖圈束縛','丟出癢癢草','躲在牆角取暖',
                '拉蠅子跘倒敵人','從龜仙人那偷來的殼','看櫻花好美哦','那裡有美女','帥氣的微笑','幫敵人戴上老花眼鏡',
                ...
                '超強LED車頭燈','便秘的痛苦','剩1元的提款薄','貼在牆上的股票','沒有蜜蜂的蜂窩','檳榔攤的結冰水',
                '掉地上的冰淇淋','面試官是前前女友'
                ]
