...
class card_fight(object):
    ...
    def getATK(self,atk, lucky, wiz_value):
        ...
        atk1 = ['拿棒棒糖攻擊','丟石頭','戳一下','丟樸克牌','丟RAM攻擊','咬一口','丟榴槤',
                ...
                '冥醫的根管治療','雷恩的七星刀','倫家吃不完','一隻小雨傘','灑石灰','拜請天兵天將','丟進曼陀珠的可樂',
                ...
                '踩腳趾','滿福堡加蛋不要蛋','懷疑人生咒','無盡的宮廷劇','沒剎車的鐵馬','幹話大全','紅鶴之舞','寒冷西北風',
                '牛郎一百零八棍','迷因力量','過期的五倍券'
                ]
        atk2 = ['強力攻擊','破壞拳','迴旋踢','關門放狗','伸長吧~~拳頭','奧客精神','RAP碎碎唸','恐龍攻擊',
                ...
                '天心蓮環','凌空三條腿','隔山打牛','貞子的頭髮','史萊姆的靈魂詛咒','ET手指捅鼻術','機械神武裝',
                '買錯的驗孕棒二條線']
        atk3 = ['龜派氣功波','超級飛踢','三刀流~鬼斬','三寶上路','卍解','霸王龍之吻','昇龍拳','奪命剪刀腳',
                ...
                '戰神質詢術','電角神拳','無敵穿牆術','光子力熱線','木蘭飛彈','去吧!稻中兵團','鳥巢驚魂發球','小金人巴掌']
        atk4 = ['致命一擊','必殺一擊','元氣彈','跪鍵盤密術','三檔 骨氣球','九九重陽功','唱歌攻擊','召喚殺很大','天心補刀腳'
                ...
                '解不完的每日','勊蚊者拭掌','單身憤怒神拳','人生勝利組光線','電影院裡的雞排味','慣老闆邪惡的笑容','Project下班交給我','地獄極樂落',
                '上上下下左左右右ABBA','破精自絕大法','快篩二條線']
        atk9 = ['讓對手拉肚子攻擊','放屁臭死了對手','召喚了神龍，進行攻擊','共體時艱','油電雙掌']
    ...
    def getDEF(self,DEF, lucky):
        ...
        def0 = ['扮鬼臉嚇人','盾檔','太極一式','講笑話','岩壁','灑豆子趕人','格檔','招架','我是香菇',
                ...
                '抖音兔子帽','上京告御狀','愛情摩天輪','區間測速30公里','肯德基蛋塔'
                ]
        ...
        def2 = ['超級防禦','盾牆','冰牆','催眠術','變張3讓對方傻住','混元一氣功','拿鏡子給敵人','灑鈔票','隔壁老王',
                ...
                '秘室裡的屁味','鑽石鑽石亮晶晶','你看我的項鍊','纏在一起的耳機線','滿滿的香菜','OVER MY BADY',
                ...
                '去死去死團加油','氪金霸王氣','必殺騙人喬-彗星鐵鎚','奇門五轉','碧海潮生曲','點你淫蕩穴','愛情摩天輪','鳥渡術',
                '封天閉地','不沾鍋神掌','白海肫轉彎術','PCR陽性證明','不可以色色','梅普露究極防御','無下限咒術']
        def9 = ['我閃我閃我閃閃閃','你看不到我','嘿嘿~你打不到我','究極防禦','聖盾術','小星星壞掉了','國防布','不死七幻','無量空處']
