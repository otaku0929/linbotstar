...
class card_fight(object):
    ...
    def getATK(self,atk, lucky, wiz_value):
        ...
        atk2 = ['強力攻擊','破壞拳','迴旋踢','關門放狗','伸長吧~~拳頭','奧客精神','RAP碎碎唸','恐龍攻擊',
                ...
                '火車上的拍肩掌','胖小孩的雙下巴','飛天鹹豬手','蓋亞能量炮','Tmama衝擊波']
        atk3 = ['龜派氣功波','超級飛踢','三刀流~鬼斬','三寶上路','卍解','霸王龍之吻','昇龍拳','奪命剪刀腳',
                ...
                '連續開會12小時','眼角的魚尾紋','焰之球','天上飛來的靴子','Tamama嫉妒玉']
        atk4 = ['致命一擊','必殺一擊','元氣彈','跪鍵盤密術','三檔 骨氣球','九九重陽功','唱歌攻擊','召喚殺很大',
                ...
                '飛吧神鳥鳳凰','Looooong龍拳','爛尾專案','邪王炎殺黑龍波']
    ...
    def lucky_time_items(self,ser_name,res):
        ...
        dict = {
                ...
                '2':['紅色藥水','藍色藥水','橙色藥水','攻擊增加藥水','防禦增加藥水','地獄辣椒','白馬乎你夯'],
    ...
    def item_detail(self,val):
        ...
        dict = {
                ...
                '攻擊增力藥水':{'index':'ATK','value':1000,'detail':'增加攻擊力1000點'},
                '地獄辣椒':{'index':'ATK','value':1500,'detail':'增加攻擊力1500點'},
                '大瓶裝攻擊增力藥水':{'index':'ATK','value':2000,'detail':'增加攻擊力2000點'},
                '防禦增力藥水':{'index':'DEF','value':1000,'detail':'增加防禦1000點'},
                '白馬乎你夯':{'index':'DEF','value':1500,'detail':'增加防禦1500點'},
                '大瓶裝防禦力藥水':{'index':'DEF','value':2000,'detail':'增加防禦2000點'},
