...
class start_talk(object):
    ...
    def star_talk(self, messages_talk, user_name=None):
        ...
        if re.search('^阿娜答',messages_talk):
            return self.talk_dict('阿娜答',user_name)
    ...
    def talk_dict(self,res,u=None):
        ...
        dict={
                ...
                '玻璃心':['鏘──','碎了就掃一掃吧','我那有那麼脆弱','嗚~~~~~~~','對不起傷害了你，傷了你的感情，我聽見有個聲音...'],
                ...
                '最白痴':['當然不是我','你啊~不然還有誰','這裡就我們二個~我不是~那你說呢?','什麼~為什麼這樣問','你知道問這個問題你媽為傷心嗎?','真的要我說出來?',
                       '白痴沒關係~別白吃就好~快去工作'],
                '最色':['當然是%s囉'%u,'你看看你抽到口水都流出來了','你你你~就是你~%s'%u,'誰不好色呢?','這問題我不好意思回答啦','子曰:食色性也~','色不打緊~不要太快射就好~'],
                ...
                '色鬼':['明明都是你教我的','不知汝之所言','食色性也','我明明就很純潔','%s 才色'%u,'明明就在講正常的事','誰不色啊','色好啊~嘿~~~~',
                      '牡丹花下死，做鬼也風流'],
                ...
                '早安':['%s早安'%u,'熬早','牛沒奶','Good Morning','早安~祝你有美好的一天','記得吃早餐哦','%s早安~來杯咖啡嗎?'%u,'起來動一動吧~','%s 別滾床了'%u,
                      ...
                      '%s早安，記得戴口罩哦'%u,'早，有你的早晨就是美的一天','怎麼一早就看到你，我不要我不要~~~','親愛的，人家要一個早安親親',
                      '這是夢嗎?為什麼一起床就能看到你?','太陽出來了，天菜寶寶說~~你好!!!'],
                ...
                '晚安':['晚安','晚安 %s'%u,'嗯~我也要睡了','乖乖睡哦','噓~快睡吧','zzzzzz','噓~~~~','記得睡前先尿尿哦','%s 別尿床了哦~'%u,'記得刷牙哦~','%s 刷牙了嗎?'%u,'關燈睡覺',
                      ...
                      '快快睡，明天才有精神哦','要我陪睡嗎?','我也要一起擠一擠','有點晚囉，快去睡吧','要抱著我睡嗎?','一夜好夢，忘記所有憂愁',
                      '蓋好被子，不要著涼，感冒了我可是會心疼的！','喝杯熱牛奶，讓你輕鬆入睡','天冷了擁抱我讓妳一夜好眠',
                      '浪漫夜裡，願你有個甜甜的美夢'],
                ...
                '哈':['笑屁','笑什麼笑~牙齒白啊','嘴巴再張大一點','我看到金牙了','笑什麼','有什麼事那麼好笑?','哈','哈哈','哈哈哈','哈哈哈哈哈','%s 什麼事那麼開心?'%u,
                     '%s有開心的事要跟我分享嗎?'%u],
                '哈N':['嘴巴張那麼大做什麼','笑的那麼開心~都看到喉嚨了','嘴巴張那麼大~小心蟲蟲飛進去','什麼事那麼開心','丟隻蟑螂進去','是誰放屁?',
                      '12345 哇還有金色的耶','控制一下哦~1樓都聽到你在笑了','安靜~有敵人'],
                ...
                '壞了':['保修價8萬1~','維修專線0800080000','你弄壞的厚~','舊的不去新的不來','不是我弄壞的~','賣了就當廢鐵賣了',
                      '%s 你才壞掉了'%u,'快呼叫星爸','沒壞啦','小星星不壞女人不愛','維修專線~忘了','甘啊捏','就是不給你抽',
                      '維修費888，特價優惠888','我只是睡著了而以','想我了嗎?'],
                ...
                'random':['小星星永遠在這裡','2021小星星還是伴著你唷','就算大家都忘了你，還有我在',
                   ...
                   '%s 要唱歌嗎?'%u,'登愣~我跳出來啦~','噓~跟你說一個秘密~','%s開車了厚'%u,
                   '你長得好像我一個朋友，未來的女朋友','霹靂卡霹靂拉拉 波波力那貝貝魯多','%s我要進來了'%u,
                   '拍拍砰呸 噗哇噗哇噗 ','帕美魯克 拉魯克 拉哩摟哩波','修但幾勒','當我是塑膠的嗎?',
                   '%s 你知道嗎人一生中可以喝一次岩漿'%u,'你有freestyle嗎','全集中呼吸',
                   '嚇死寶寶了','言之有理乎','假的~都是假的~~','%s這位施主 我看你印堂發黑 噴個酒精淨化一下吧'%u,
                   '啊~我眼睛業障重','各位觀眾~一顆小星星~~','沒事退朝','UCCU','我姑媽割雞皮呀送給他',
                   '那我去睡了哦~','星星不壞, 女人不愛','星爸~有人欺負我~~','要好好活下去，因為每天都有新的打擊',
                   '你傻了啊~','笑什麼笑~牙齒白啊!', '抽籤算命嗎? 不準找星爸~','幹話不是人人都可以掌握的',
                   '老闆~來一份蛋餅+無榶綠茶','此言差矣~吾向來木訥寡言的~','麻雀雖小，也沒有我小，因為我超雖小',
                   '再靠近一點~看到了嗎? 我的眼中有個美女~','%s很愛叫我耶'%u,'別減肥了，你的醜不是因為胖',
                   ...
                   '你喜歡我的名字嗎? 我很喜歡耶~','啊~啊啊~~啊啊~~~啊~~~~~','小星星露出了姨母笑',
                   '叫什麼叫~看到那顆樹了嗎?左去右回~來回10圈~~~','你喜歡看日劇嗎?',
                   '又叫我~無聊就抽卡拉霸比大小啊~~','愛地球~也要愛星星唷','%s帶我吃雞'%u,
                   '你已經掉入我的陷阱了 翻開覆蓋的卡~ 抽~','我要代替星星懲妳',
                   '因為他就是個小鬼啊','以星拔的名義發誓！','這個幻想由我來打破',
                   '真相永遠只有一個','絕對、不會有事的','我想只要笑就可以了','是不是很棒'
                   '你從什麼時候開始產生了有女朋友的錯覺？','警察叔叔 就是這個人!!',
                   '恰恰~~~~~~~~~~~碰恰恰~碰恰恰','去沖個水好好冷靜吧','你是白癡嗎？',
                   '沒可能啊 沒可能有這種事','還沒 還沒結束呢!','地球的一切都令人很懷念呢',
                   '給我坐下','妳偷了很重要的東西 就是我的心啊','歸剛唉','%s 史密斯?'%u,
                   ...
                   '安西教練 我好想抽一張啊','還差的遠呢！','WWW','我要躲進二次元的世界裡',
                   '一起去很多地方 一起見識許多的事物 這趟旅途 一定很快樂的','%s是卑鄙源之助'%u,
                   '笑什麼笑~牙齒白啊','耳朵長包皮啊','跟妳說~星拔都是靠照騙','是在哈佛',
                   '筆咧~筆咧~黛筆的筆咧~~','別看我~妳會愛上我','怎麼壞~嘿嘿嘿',
                   '噓~聽到我的心跳了嗎? 只要一靠近妳就心跳加速','奇怪的知識增加了',
                   '說吧~說妳愛我吧','不要再追著我的幻影~要學會成長','666','刷一波',
                   '哇~是A歌王子耶','城門城門雞蛋糕~身把三把刀~要五毛~捅一刀~走進城門滑一蕉',
                   '學海無涯，回頭是岸','到底是誰教你這樣講話的','年輕人不講5的','耗子尾汁'
                   '二隻蚊仔～二隻蚊仔～拍呼死～拍呼死～只隻飛來這邊～只隻飛企虛邊～拍麥丟～拍麥丟',
                   ...
                   '人來啊，落閘，放狗！','文也不行，武也不行，醒醒吧！','歐力給',
                   '實不相瞞，小弟我就是人稱玉樹臨風勝潘安，一支李花壓海棠的鮮帥哥~小星星！',
                   '現在聽懂沒有？','我正在談兒女私情，改程式這種小事改天再說啦！',
                   '只要有心~人人都可以是幹話大王','喝醉了我誰也不服，就扶牆！','噯唷很會旋轉奈',
                   ...
                   '我的優點是：我很帥；但是我的缺點是：我帥的不明顯','%s來談談你的CP吧'%u,
                   '人家有的是背景，咱有的是背影,還特別的厚實','抱歉了%s，但我真的需要那個酷東西'%u,
                   '羊腸小道,GG小一號','我不是不想減肥，我只是怕反彈而已',
                   '錢不是問題，問題是沒錢','人生就像衛生紙，沒事的時候，儘量少扯！',
                   '我很純潔的，就像再生紙一般','%s 你真的是他媽的幹話王耶!'%u,
                   '我覺得妳看起來有點營養不良，建議妳可以吃掉羊羊','你覺得CP生氣了要怎麼辦',
                   '只要每天省下買一杯奶茶的錢，十天後就能買十杯奶茶','%s聽說你很會把妹哦'%u,
                   '當你的左臉被人打，那你的左臉就會痛','煎魚一直不翻面，就一定會燒焦',
                   '當我眼睛閉上時 我就看不到','你們是在安靜什麼啦','我不管啦，今天你不講我就.....',
                   '冰淇淋不拿去冰，一定會融化，統一除外','偷偷告訴你，在床上尿尿就會尿床',
                   '我先了解一下，之後再回覆你','我必須公平對待每個人','我想這事情原本就不該發生⋯⋯',
                   '我很想幫你加薪，但是⋯⋯','%s 這麼晚還在加班啊？'%u,'我家有養貓唷',
                   '根據研究，人類的死因有99%是因為無法吸到下一口空氣','大大大優惠',
                   '墮落是不需要理由的，但是，不墮落卻是有原因的','終於，結束了啊','奇怪的知識增加了',
                   '%s 去實現夢想吧，啊~~~~~~'%u,'%s 你，是誰？'%u,'說了一個不得不說的謊',
                   ...
                   '他是我的靈魂也是我的驕傲,出來吧!青眼白龍~~~','就決定是你了','%s 不可以色色'%u,
                   '滴滴滴滴滴～～～嗶嗶！時間到！','你是笨蛋嗎？','又砍了無聊的東西了啊…',
                   'σ`∀´)σㄎㄎ','將你的幻想抹殺掉','我得到神騎寶貝了','什麼是快樂星球？我現在就帶你研究！',
                   '剛好……一分鐘…你做了一場好夢了嗎?','%s就這樣插進去就行了'%u,'我是輸給了地球的重力',
                   '那是要給我的嗎?','爸說，陌生人的東西不可以吃','%s和我簽訂契約吧'%u,'戳一個',
                   '重要的日曆缺了一頁','我好像有點強','你比的贏GG的舌頭嗎?','興奮到模糊',
                   ...
                   '你他媽王八蛋！非他媽逼老子破戒！看我他媽的不打你他媽的這個王八蛋！','アスパラ',
                   ...
                   '電腦分析33%是5，34%是7，15%是K，18是J，數據不夠，暫時分析不到是什麼牌','你變瘦了，怎麼辦到的，可以教我嗎?',
                   '喂？喂？喂？你是不是%s啊？喂～講話啊？喂？'%u,'想知道就問香蕉','你怕了嗎？','總是少了一點安全感',
                   ...
                   '天底下有什麼事情　能讓人幸福？','己經忙得團團轉　還站在旋轉的地球','有太多的慾望，小心變成怪物哦',
                   ...
                   '雖然妳喜歡別的男生，可我還是很喜歡妳','喜歡上一個人，是會不知不覺的','不是不想你，只是沒說出口',
                   ...
                   '空洞的人，所培養出來的也是空洞的人際關係，%s覺得呢?'%u,'人是沒有距離的，有距離的是人的心','你看見天堂了嗎? 排隊序號尚有9487人',
                   '如果不知道該選那邊時，那就選該做的事。兩邊都是後悔，那就選後悔較小的那邊吧！','聖光~~~~','不努力一下，你怎麼會知道什麼叫做絕望',
                   '「臨、兵、鬥、者、皆、陳、烈、前、行」','乖 把你的手放下','老闆，來盤寂寞','臭屁不響，響屁不臭，其實只是你鼻塞又耳屎多',
                   '「神敕明敕，天清地清，神君清君，不不濁。鬼魅當降服、陰陽當合和，急急如律令！降服！傲濫！」',
                   '我覺得人的哭有兩種，覺得自己很可憐的哭，和單純傷心的哭。','什麼時候女人們說的話最少？','不用太在意一些人說的話，因為他們有嘴卻不一定有腦',
                   ...
                   '能夠把自己吃的苦，當做對自己的磨練，這說明你已經準備好，為自己的夢想去拼搏了。','喜歡就去告白呀，說不定人家也等著拒絕你呢！',
                   ...
                   '用我一生，牽你的手','上網第一條原則，不看評論區','你臉真多','兄弟，我尊重你的人生','%s你有什麼不開心的事? 講出來讓大家開心一下嘛'%u,
                   '如果知道自己的生命剩不到一分鐘，你會怎麼做？','有時候你沒發現，你曾遇過最美好的事，一直在你眼前。',
                   '就算你再弱，我也會站在妳面前保護妳','如果我的離去能讓妳開心，那我決定留下來守候妳','自從得了神經病，我整個人精神好多了,%s 你也是嗎?'%u,
                   '如果有一種藥可以讓我開心，那就是妳','哼，氪金還不是被我打扁扁','為什麼地板那麼的冷啊','人家都有個好爸爸，我只有....',
                   '什麼叫脫褲子放屁，你懂嗎?','你這個中二，我才不是小屁孩','那只是一場遊戲一場夢，夢醒了、哭過了就會好了吧',
                   '我是真的愛上了你，可是我不敢告訴你','喜歡妳，真的真的喜歡妳','什麼時候才能跟妳一起去環遊全世界呢?',
                   '天啊!你真高','一米三的看過嗎?','我要把你趕出我的船','金錢不是萬能的','生命總會在最黑暗的地方綻放','別再說窮到被鬼抓走了，因為連鬼都嫌棄你窮',
                   '我不是中二，我只是肚子餓','我有一千個詞匯來形容大海的美麗，卻找不到一個詞來形容你的無聊','曖昧就像放屁，你知道，我知道，但是彼此裝作不知道',
                   '快醒醒，你老闆在看著你','我很寂寞','這個世界就由我來拯救','啊~我的右手!不受控制!','我的興趣分為靜態和動態兩種，靜態就是睡覺，動態就是翻身',
                   '外面的風兒，總是喧鬧','呵，有點意思','快走，我快控制不住惡魔的力量了','媽呀，別關燈! 我怕黑!',
                   '時間是一張糾結的網，不要去探究每一條線索','你有喝過蜂蜜檸檬水嗎?','看看妳，睡到都流口水了','眼前的黑不是黑，是你長胖了，都擋住我的視線了',
                   '因為我愛你，所以永遠鬥不過你。','為了這世上的魚和雁，妳還是少笑一點好','別傻了，沒有人心疼的傷心不值錢',
                   '在你轉身錯落的那個輪回間，我已萬劫不復','我不相信正不相信邪，但我相信你','人家有背景，而我只有背影',
                   ...
                   '到底會不會啊','翅膀硬了才能飛，那你到底硬了沒?','集中一點，登峰造極','從那一刻起，我打心底里嫉妒那位名叫%s的天才'%u,
                   '抱歉，這裡太亂了，主人，我馬上打掃乾淨!','不就是個戀態嗎? 有什麼了不起的','你會不會用屁股坦王啊?',
                   '我愛江山更愛美人','人生短短幾個秋啊　不醉不罷休 東邊兒我的美人哪　西邊兒黃河流 來呀來個酒啊　不醉不罷休　愁情煩事別放心頭',
                   '%s有玩抖音嗎?'%u,'龜派氣功 (ﾟДﾟ)< ============O))','人生就像天空一樣，有季節更迭，時刻在變；它雖然不會一直晴空萬里，但也不會總是大雪紛飛',
                   '弱者沒有權利，無從選擇。','你就不能用自己的頭腦思考一下嗎？','情緒支配下的攻擊，兩個字，愚蠢。','你敷面膜的時候，比本人好看多了',
                   '如果光憑「憤怒」就能勝利，那世界上就不會有鬼了。','就算痛苦到難以忍受，請你不要逃避這份痛苦，努力活下去。',
                   '鬼是空虛的生物，是悲傷的生物，但不見得是怪物。','心，是人類的原動力，強大的心是無邊無際的。我們就用這樣的原動力，朝向明日前進。',
                   '我們因為守護所愛的人事物而脆弱，但也因為他們而強悍。','別害怕，抬起頭來，因為你並沒有做錯什麼。',
                   '縱使我身形俱滅，也定將惡鬼斬殺。','即使停下腳步，徘徊不前，時間也不會停止流逝，它才不會駐留在你身旁，陪著你一起呼天搶地。',
                   '大哥沒有輸','以心為原動力，向著明日前進','我做的很好了，你不誇誇我嗎？','你在幹什麼，%s'%u,'想不到%s也墮落了'%u,
                   '我自幼就很聰明伶俐，無論何時何地都給予人們幸福，因為這是我的使命','做的好，%s'%u,'燃燒吧，燃燒吧，讓心燃燒吧！',
                   '你不是要成為柱嗎？%s'%u,'我是新晉的柱，靠的柱','毛都還沒長齊，還想抽牌?','%s 你大老遠跑來就因為我攻擊了你的村莊?'%u,
                   '小心我把你隔離14天哦!!!','走開，你走開，沒戴口罩不要靠近我','嗯哼，然後咧?','小屁孩就這樣嗎?','%s 你不要攻擊我的村莊啦'%u,
                   '在哪裡跌倒，就在那躺下','你浪費兩分鐘，整個群組就浪費了一小時','群主什麼時候要發紅包啊','心情自然涼','喜歡是一種選擇，而愛是非妳不可',
                   '我不曾順手牽羊，但我想順手牽妳','最近想要開始追星，追妳這顆閃亮的星','追劇不如追妳，因為妳更好看','黑衣人是什麼?黑頻才夠嗆',
                   '阿我就怕被罵','今晚，我想來點⋯⋯','轟隆隆隆，引擎發動','奇怪的智識增加了','分享長壽秘訣.......保持呼吸，不要斷氣',
                   '人家說：你給我十分鐘，我給你十個月。但是你咧還有九分半要做什麼','肝若壞，人生是黑白的；肝哪好，考卷是空白的',
                   '你最近是不是常常跌倒？要不然怎麼一直在地震','感覺搖晃不要怕，只是星爸又跌倒了','自殺不能逃避問題，但裝死可以',
                   '從猴子到人需要一萬年，從人到猴子只需一瓶酒','你知道誰是吞吞嗎? 不知道可以抽抽看，或許就能抽到他哦',
                   '我吃東西不是肚子餓，只是嘴巴寂寞','子傻是的看來過倒'
                   ]
                }
