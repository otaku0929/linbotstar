    ...
    def talk_dict(self,res,u=None):
        ...
        dict={
                ...
                '哈':['笑屁','笑什麼笑~牙齒白啊','嘴巴再張大一點','我看到金牙了','笑什麼','有什麼事那麼好笑?','哈','哈哈','哈哈哈','哈哈哈哈哈','%s 什麼事那麼開心?'%u,
                     '%s有開心的事要跟我分享嗎?'%u],
                '哈N':['嘴巴張那麼大做什麼','笑的那麼開心~都看到喉嚨了','嘴巴張那麼大~小心蟲蟲飛進去'],
                ...
                'random':['一閃一閃亮晶晶 滿天都是小星星','是誰在叫我啊','你看不到我0.0',
                   ...
                   '我覺得人的哭有兩種，覺得自己很可憐的哭，和單純傷心的哭。',
                   '要是你那個裝滿淚水，像個水桶的腦袋也明白了的話，就幫我把鞋穿上吧。',
                   ...
                   '你絕對絕對絕對不是我喜歡的類型！','里特．拉多巴里達．烏魯蘇．亞里亞洛斯．巴魯．奈多利路',
                   '塔卡拉普特．波波倫加．普比利特．帕羅','一天又平安的過去了，感謝小星星的努力吧!',
                   ...
                   '發明望遠鏡只為讓妳看到最美最亮的星','當你對一件事情說好的時候 你就擁抱了可能性',
