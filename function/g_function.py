...
def main():
    ...
    print (gfunction.weekDay(2018,9,1))
...
class function(object):
    ...
    def weekDay(self, year, month, day):
        ...
        dayOfWeek %= 7
        int_day = int(dayOfWeek) 

        #weekdate_s = '%s-%s-%s'%(year,month,day-int_day+1)
        #weekdate_e = '%s-%s-%s'%(year,month,day+6-int_day)
        
        return int_day, week[int_day] 
