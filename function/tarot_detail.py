...
def tarot_random():
    return tarot_detail(str(random.randint(0,21)))
...
#empress
    if re.search("6|7|empress|女皇",res):
        if re.search("6|u|正位",res):
            title = "女皇(正位)"
...
#emperor
    if re.search("8|9|emperor|皇帝",res):
        if re.search("8|u|正位",res):
            title = "皇帝(正位)"
...
#hierophant
    if re.search("10|11|hierophant|教皇",res):
        if re.search("10|u|正位",res):
            title = "教皇(正位)"
...
#lovers
    if re.search("12|13|lovers|戀人",res):
        if re.search("12|u|正位",res):
            title = "戀人(正位)"
...
#chariot
    if re.search("14|15|chariot|戰車",res):
        if re.search("14|u|正位",res):
            title = "戰車(正位)"
...
#strength
    if re.search("16|17|strength|力量",res):
        if re.search("16|u|正位",res):
            title = "力量(正位)"
...
#hermit
    if re.search("18|19|hermit|隱者",res):
        if re.search("18|u|正位",res):
            title = "隱者(正位)"
...
#wheeloffortune
    if re.search("20|21|wheeloffortune|命運之輪",res):
        if re.search("20|u|正位",res):
            title = "命運之輪(正位)"
