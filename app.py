...
def talk_messages(messages_talk):
    ...
    if messages_talk in {'爆料',"八卦"}:
        content = random.choice(['卡一個','爆米花準備好了','沒圖沒真相','有卦快抄','爆漿會不會比較精彩','筆記ing','乾、坤、坎、離、震、巽、艮、兌'])
        return content
    ...
    if messages_talk in {'小星星'}:
        content = random.choice(['一閃一閃亮晶晶 滿天都是小星星','是誰在叫我啊','你看不到我0.0','來了來了~','麥吵,底睏啦~','小星星你的好幫手','要抽一張嗎',\
                                 ...
                                 在那天上放光明  我已經決定要愛你 就不會輕易放棄','要唱歌嗎?','登愣~我跳出來啦~','噓~跟你說一個秘密~',\
                                ...
                                '星星不壞, 女人不愛','星爸~有人欺負我~~','你傻了啊~','笑什麼笑~牙齒白啊!','抽籤算命嗎? 不準找星爸~',
                                '此言差矣~吾向來木訥寡言的~','再靠近一點~看到了嗎? 我的眼中有個美女~','我只是略懂略懂啦~','嚇到吃手手',\
                                '你知道為什麼你眼睛很漂亮嗎?因為妳的眼裡有我','啊!我就只會這麼多啊~不然妳教我','這不是肯德雞~~~',\
                                ...
                                '啊~啊啊~~啊啊~~~啊~~~~~','叫什麼叫~看到那顆樹了嗎?左去右回~來回10圈~~~','又叫我~無聊就抽卡拉霸比大小啊~~'])
        return content
